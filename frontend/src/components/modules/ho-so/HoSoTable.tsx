...
import { VnptWarningFooter } from "@/components/ui/VnptWarningFooter";
    ...
    <div className="w-full bg-gray-50/50">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 bg-white rounded-xl border border-gray-200/80 shadow-sm overflow-hidden flex flex-col">
          <div className="w-full flex flex-col mt-4 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            {/* 1. Thanh Header tinh gọn - Đảm bảo KHÔNG BAO GIỜ bị tràn hay bóp nghẹt chữ */}
            <div className="p-4 bg-gray-50/70 border-b border-gray-200/60 flex items-center gap-2.5">
              <BiAnchor className="text-blue-600 w-5 h-5 shrink-0" />
              <h2 className="text-sm font-bold text-gray-800 leading-tight">
                1. Hồ sơ theo Công trình & Giai đoạn
              </h2>
            </div>

            {/* 2. Khu vực nội dung bên dưới Header (Bao gồm Khối cảnh báo VNPT) */}
            <div className="p-4 flex flex-col gap-4">
              {/* NƠI CHỨA NỘI DUNG/DANH SÁCH HỒ SƠ CỦA ANH SẼ ĐẶT Ở ĐÂY */}
              <button
              ...
              <div className="text-xs text-slate-400 italic">
                {/* Ví dụ: Danh sách các giai đoạn hoặc dữ liệu bảng... */}
                <div className="p-4 flex-1 space-y-4">
                  <div className="space-y-4">
                    {filteredData?.slice(start,end).map((project) => (
                      <div
                        key={project._id}
              ...
              {/* Khối cảnh báo VNPT tĩnh được đặt riêng biệt dưới cùng của Card */}
